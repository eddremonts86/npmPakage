            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">
                        Comprehensive example showcasing all TaskManager
                        features
                    </p>
                </div>
                <div className="flex items-center gap-2">
            ...
            <Card className="p-6">
                ...
                <div className="space-y-3 text-sm">
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            <strong>Sorting:</strong> Click on any column header
                            to sort. Click again to reverse the sort order.
                        </div>
                    </div>
                    <div className="flex items-start gap-2">
                        <Badge
                        ...
                        <div>
                            <strong>Filtering:</strong> Use the search box to
                            filter tasks by name. Use the status and assignee
                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            <strong>Inline Editing:</strong> Click on task names
                            to edit them directly. Press Enter to save or Escape
                            to cancel.
                        </div>
                    </div>
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            <strong>Actions:</strong> Click the three-dot menu
                            on any row to see available actions (Edit, Delete,
                            etc.).
                        </div>
                    </div>
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            <strong>Keyboard Navigation:</strong> Use Tab to
                            navigate between interactive elements, Enter to
                            activate, and Escape to close dialogs.
                        </div>
                    </div>
                </div>
            </Card>
