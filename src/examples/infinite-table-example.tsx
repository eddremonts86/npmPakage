            ...
            <Card className="mb-6">
                ...
                <CardContent>
                    <div className="flex gap-2 mb-4">
                        <Button
                            variant={
                                currentView === "users" ? "default" : "outline"
                            }
                        ...
                        <Button
                            variant={
                                currentView === "posts" ? "default" : "outline"
                            }
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="space-y-2 text-sm">
                        <li>
                            • <strong>Virtualized scrolling</strong> - Handles
                            large datasets efficiently
                        </li>
                        <li>
                            • <strong>Sortable columns</strong> - Click column
                            headers to sort
                        </li>
                        <li>
                            • <strong>Custom rendering</strong> - Render custom
                            components in cells
                        </li>
                        <li>
                            • <strong>Flexible styling</strong> - Works with or
                            without Tailwind CSS
                        </li>
                        <li>
                            • <strong>Responsive design</strong> - Adapts to
                            different screen sizes
                        </li>
                        <li>
                            • <strong>Public API integration</strong> - Fetches
