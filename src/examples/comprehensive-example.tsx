        ...
        <Card>
          ...
          <CardContent>
            <div className='flex gap-2 mb-4'>
              ...
              <Button variant='outline' onClick={toggleStylingMode}>
                {useTailwind ? 'Switch to CSS-only' : 'Switch to Tailwind'}
              </Button>
            </div>

            <p className='text-muted-foreground'>
              This library works with or without Tailwind CSS. Current mode:{' '}
              <strong>{useTailwind ? 'Tailwind' : 'CSS-only'}</strong>
            </p>
          </CardContent>
        </Card>
...
@tailwind utilities;`}
              ...
              <div>
                <h3 className='font-semibold mb-2'>Without Tailwind CSS</h3>
                <pre className='bg-muted p-4 rounded text-sm overflow-x-auto'>
