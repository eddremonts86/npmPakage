...
The **Schilling Widgets System** is a complete UI component library for React that offers:

-   **Total Flexibility**: Works with or without Tailwind CSS
-   **Complete Components**: All essential Shadcn UI components
-   **Advanced Widgets**: TaskManager and InfiniteTable with virtualization
-   **TypeScript First**: Complete types and IntelliSense
...
├── 🎨 Styling System (Tailwind + CSS-only)
...
### Configuration without Tailwind CSS

```tsx
import { configureTheme } from "@schilling-apps/schilling-widgets-system";

// Configure at your application entry point
configureTheme({
    useTailwind: false,
    theme: "light", // or 'dark'
});
